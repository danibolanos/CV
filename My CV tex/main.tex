...
{
    \LARGE{\textcolor{RoyalBlue}{D}}\large{\textcolor{RoyalBlue}{ANIEL}} \LARGE{\textcolor{RoyalBlue}{B}}\large{\textcolor{RoyalBlue}{OLAÑOS}} \LARGE{\textcolor{RoyalBlue}{M}}\large{\textcolor{RoyalBlue}{ARTÍNEZ}} \newline
    \vspace{-6mm}
    
    \small{
        \clink{\includegraphics[width=0.4cm]{images/email.png} 
          \textbf{Email:}  \href{mailto:bolanosmartinezdaniel@gmail.com}{bolanosmartinezdaniel@gmail.com}
        \newline \includegraphics[width=0.4cm]{images/link.png} 
        \textbf{LinkedIn:} \href{https://www.linkedin.com/in/danielbolanosm}{linkedin.com/in/danielbolanosm}
        \newline \includegraphics[width=0.4cm]{images/git.png} 
...
% right side %
{
    ...
    \csection{EXTRA}{\small
        \begin{itemize}
            \item \frcontent{Interested in:}{Machine Learning, Data Science, Business Intelligence, Deep Learning, Cloud Computing, Open Source.}{}{}
            \vspace{-7mm}
